...
parser.add_argument('mask', type=str, help='edge mask')
...
# 2*pi*sigma/(1/d1-1/d2)*N/(N+1)**2
gm = 3.35237311307434e-09
...
#mask = np.load('cube-comp/mask_151217_145902.npy')
mask = np.load(args.mask)

prop = g.new_edge_property('bool',vals=mask)
...
if num_vert+1 not in vcc_path:
    log.warning("not percolating!")
...
# nodes that are just below the top plane of nodes
...
fixed = set(range(l))-others # nodes not in vcc_path or those on the top/bottom
